                 ...
                 <div class="card">
                     ...
                     <div class="card-body">
                         <div class="review-block">
                             ...
                             <p class="review-text font-italic m-0">배고파여 떡볶이 먹고싶당 ㅎㅎ </p>
                         ...
                         <div style="display: flex;">
                         	<textarea style="width: 90%; margin-top: 10px; border-radius: 5px;"></textarea>
                         	<a href="#" class="btn btn-primary active" style="    height: 41px; margin-top: 13px; margin-left: 5px;">작성</a>
                         </div>
                     </div>
