                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="page-header">
                            <h2 class="pageheader-title">완료된 주문</h2>
                            ...
                            <div class="page-breadcrumb">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item"><a href="#" class="breadcrumb-link">완료된 주문</a></li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                                       		...
                                       		<% int count = 0; %>
												<c:forEach var="r" items="${list }">
		                                            <tr>
		                                                ...
		                                                <td>
		                                                	 <c:choose>
																<c:when test="${r.or_Status eq '5'}"><span class="badge-dot badge-info"></span><a id="statusText<%= count %>">구매확정</a></c:when>
															</c:choose>	
		                                                </td>
		                                                <td>
