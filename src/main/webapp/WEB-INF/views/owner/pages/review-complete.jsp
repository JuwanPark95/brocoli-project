                        ...
                        <div class="page-breadcrumb">
                           <nav aria-label="breadcrumb">
                              <ol class="breadcrumb">
                                 ...
                                 <li class="breadcrumb-item active" aria-current="page">완료된 후기</li>
                              </ol>
                           </nav>
                        </div>
                     </div>
                                       ...
                                       <td style="width: 100%;">
                                          <div class="card-body">
                                             ...
                                             <div class="review-block" style="padding: 8px;">
	                                               				...
	                                               				<c:choose>
					                                                   ...
					                                                   <div style="display: inline-block; padding: 5px; vertical-align: middle; width: 100%; height: auto; border: 1px solid #e6e6f2; border-radius: 5px; margin-bottom: 4px;">
						                                                   ...
						                                                   <div style=" display: inline-block; float: right;">
							                                                   	...
							                                                   	<c:url var="deleteReply" value="comReplyDelete.ow" >
	                                                ...
	                                                <form action="comReply-Insert.ow" method="post" enctype="multipart/form-data" onsubmit="return checks(this)">
