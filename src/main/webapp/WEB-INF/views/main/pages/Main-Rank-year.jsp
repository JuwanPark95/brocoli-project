		...
		<div class="container">
			<div class="flex-w flex-sb-m p-b-52" style="height:75px;">
				<div class="flex-w flex-l-m filter-tope-group m-tb-10" >
					...
					<a href="${year }" class="stext-106 cl6 hov1 bor3 trans-04 m-r-32 m-tb-5 how-active1" style="font-size:20px;" data-filter=".bag">
						년별
					</a>
         ...
         <c:forEach var="year" items="${ yearList }">
         	<c:url var="productDetail" value="productDetail.mn">
           		<c:param name="p_NO" value="${year.p_NO }"/>
           		<c:param name="or_Mno" value="${loginUser.mNO }"/>
   	        </c:url>
            <div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item ${year.p_Bcategory} ${year.p_Scategory}">
               <div class="block2">
                  <div class="block2-pic hov-img0" id="productModal">
                     <img src="/brocoli/resources/product-Img/${year.pfList.pf_Img1_ReName }" alt="IMG-PRODUCT" style="height:378px;">
				<input type="hidden" id="productNo" value="${year.p_NO }">
                  ...
                  <div class="block2-txt flex-w flex-t p-t-14">
                     ...
                     <c:url var="wInsert" value="wInsert.mn">
					 	<c:param name="w_P_NO" value="${ year.pfList.p_NO }"/>
