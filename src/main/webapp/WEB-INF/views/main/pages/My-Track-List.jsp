...
<link rel="stylesheet" type="text/css"
	href="/brocoli/resources/mainResources/css/trackList.css">
<style>
input {
			...
			<div class="row">
				...
				<div class="cell_order_form box_address_cell">
					<div class="clear cell_order_form1 border_add_order">
						...
						<ul class="box_receiver_info">
							...
							<li class="cell_discount_detail"><label
								class="box_choice fist"> <input type="radio"
									id="address_recently" name="adress_chk"
									onClick="Order.sameOrder(this);" checked="true" /> 최근 배송지
						...
						<ul class="box_receiver_info">
							...
							<li class="cell_discount_detail2 order_address_form box_receiver">
								...
								<input type="text" name="rcvr_nm" value="" /> <span
						...
						<ul class="box_receiver_info">
							...
							</select> <!--<input type="text" name="rmobile1" />--> - <input
								type="text" name="rmobile2" value="" /> - <input type="text"
								name="rmobile3" value="" />
							</li>
						</ul>
						<ul class="box_receiver_info">
						...
						<ul class="box_receiver_info">
							...
							<li class="cell_discount_detail2 order_address_form box_address">
								<input type="text" class="zipcode" name="rzip_cd1"
								onChange="Order.checkAddDlvFee();" size="7" value="" readonly />&nbsp;&nbsp;<a
								class="plain-btn btn btn-zipcode"
								onClick="popup_new_zipcode('rzip_cd1','rzip_addr1','rzip_addr2', 504, 688); return false;">우편번호
									찾기</a><br /> <input type="text" class="address" name="rzip_addr1"
								value="" readonly /> <input type="text" class="address detail"
								name="rzip_addr2" value="" /> <label style="line-height: 29px;"><p>
										<input type="checkbox" name="delivery_default" /> <span
											class="font_basic">기본배송지로 등록</span>
									</p></label>
							</li>
						</ul>
						<ul class="box_receiver_info">
					...
					<div class="cell_order_form2 box_buyer_cell">
						...
						<ul class="box_buyer_info">
							<li class="order_address_form box_tel"><input type="text"
								name="ophone1" value="" size="3" maxlength="3" /> - <input
								type="text" name="ophone2" value="" size="3" maxlength="4" /> -
								<input type="text" name="ophone3" value="" size="3"
								maxlength="4" />
								<div class="box_check">
