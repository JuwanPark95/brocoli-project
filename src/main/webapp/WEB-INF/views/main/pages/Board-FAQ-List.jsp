...
<div id="accordian">
	...
	<ul>
		<li id="a">
			<h1>Q 현금 환불은 언제 되나요?<span class="ico_ar">▼</span></h1>
			<ul>
				<li>무통장입금/편의점결제 후 환불 요청 시 영업일 기준으로 다음날 오후 5시 이후에 되고 있습니다.<br>
					단, 편의점결제는 수수료 2%차감후 환불됩니다.</li>
			</ul>
		</li>
		
		<li id="a">
			<h1>Q 브랜드 상품 교환/반품은 어떻게 하나요?<span class="ico_ar">▼</span></h1>
			<ul>
				<li>브랜드 상품도 소녀나라 상품과 동일하게 접수해 주시면 됩니다.<br> 
		...
		<li id="a">
			<h1>Q 재고확보된 제품부터 먼저 받을 수 있나요?<span class="ico_ar">▼</span></h1>
			<ul>
				<li>
					소녀나라의 기본 상품준비 기간은 2~7일(영업일 기준) 입니다. <br>

					상품 준비 기간(2-7일) 내에 준비된 제품 먼저 선출고 원하실 경우에는<br>
					
					배송비(2500원) 입금해주시면 발송이 가능한 점 안내드립니다.<br>
					
					선출고 요청은 1:1문의 또는 톡상담, 고객상담센터를 통해 가능합니다.
				</li>
			</ul>
		</li>
		
		<li id="a">
			<h1>Q 입금 확인이 안돼요!<span class="ico_ar">▼</span></h1>
			<ul>
				<li>
					입금확인은 은행과 사이트(소녀나라) 사이 빠른 계좌 조회 service로 자동확인이 되고 있습니다.<br>
	<br>
					...
					<br>
					위 사항 중에 하나라도 해당된다면 1:1게시판, 톡상담을 통해 남겨 주시거나 고객센터(1599-8861)로 전화 주셔야 처리됩니다. 자동취소되는 7일 이후에 입금하시게 되면 고객센터로 꼭 연락주셔야 됩니다.
				</li>
			</ul>
		</li>
		
		<li id="a">
			<h1>Q 입금을 많이 했어요.(또는 적게 입금했어요.)<span class="ico_ar">▼</span></h1>
			<ul>
				<li>
		...
		<li id="a">
			<h1>Q 주문후 입금은 언제까지 해야되나요?<span class="ico_ar">▼</span></h1>
			<ul>
				<li>
					주문후 입금은 주문일로부터 7일이내에 입금을 해주셔야 합니다.<br>
					입금이 주문일로부터 7일이 경과된후 입금을 해주시면 주문이 자동취소되어 입금확인이 되지 않습니다.<br>
					<br>
					주문이 취소 된 후에 입금을 하신경우는 고객센터(1599-8861) or 문의하기게시판으로 연락바랍니다<br>
		...
		<li id="a">
			<h1>Q 배송 전 상품병경&주문취소하고 싶어요!<span class="ico_ar">▼</span></h1>
			<ul>
				<li>
					* 1:1게시판(취소변경)또는 고객센터로 연락주시면 빠른처리도와드리고 있습니다.<br>
<br>
		...
		<li id="a">
			<h1>Q 회원ID와 패스워드를 잊어버렸어요.<span class="ico_ar">▼</span></h1>
			<ul>
				<li>
					...
					임시 비밀번호로 로그인을 하신 후 고객님께서 원하시는 비밀번호로 변경하시면 됩니다.<br>
<br>
					※ 위방법이 어려우실경우에는 고객센터 [1599-8861]로 연락하시면 본인 확인후 빠른처리 도와드리겠습니다.<br>
				</li>
			</ul>
		</li>
		
			<li id="a">
			<h1>Q 불량 사유가 안되는 경우도 있나요?.<span class="ico_ar">▼</span></h1>
			<ul>
				<li>
					...
					<br>					
					1. 실밥이 많아요.<br>
					소녀나라는 고객님들께 좋은 상품 좋은 서비스로 보답하기 위해 가격을 낮추며 중간 공정 인건비를 줄이게 되었습니다.<br>
					...
					소녀나라는 상품 포장 마지막 단계에서 상품의 구김 방지를 위해 스팀 샤워가 진행되며 바로 포장 작업을 하고 있습니다.<br>
					...
					​소녀나라 상품의 경우 상품 페이지 하단 상세 정보란에 재질마다 세탁 방법이 표기되어 있습니다.<br>
