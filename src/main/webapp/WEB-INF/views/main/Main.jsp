			...
			<div class="row">
				...
				<div class="col-md-6 p-b-30 m-lr-auto">
					...
					<div class="block1 wrap-pic-w">
						<img src="/brocoli/resources/Auction-Img/${b.ac_Img_Rename }" alt="IMG-BANNER">
				...
				<c:if test="${b.ac_Banner_NO>=3 }">
				  <div class="col-md-6 col-lg-4 p-b-30 m-lr-auto">
					...
					<div class="block1 wrap-pic-w">
						<img src="/brocoli/resources/Auction-Img/${b.ac_Img_Rename}" alt="IMG-BANNER" style="height:475px;">
						<a href="${bproduct}" class="block1-txt ab-t-l s-full flex-col-l-sb p-lr-38 p-tb-34 trans-03 respon3">
							<div class="block1-txt-child1 flex-col-l">
								<span class="block1-name ltext-102 trans-04 p-b-8">
									${b.ac_Brand}
