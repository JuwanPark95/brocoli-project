package com.kh.brocoli.product_file.model.vo;
...
public class Product_File {
	...
	public String toString() {
		return "Product_File [pf_NO=" + pf_NO + ", pf_Img1=" + pf_Img1 + ", pf_Img1_ReName=" + pf_Img1_ReName
				...
				+ ", pf_Img6_ReName=" + pf_Img6_ReName + ", pf_Dimg1=" + pf_Dimg1 + ", pf_Dimg1_ReName="
				+ pf_Dimg1_ReName + ", pf_Dimg2=" + pf_Dimg2 + ", pf_Dimg2_ReName=" + pf_Dimg2_ReName + ", pf_Dimg3="
				+ pf_Dimg3 + ", pf_Dimg3_ReName=" + pf_Dimg3_ReName + ", pf_P_NO=" + pf_P_NO + "]";
	}
