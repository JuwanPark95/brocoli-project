...
public class Magazine {
	...
	public Magazine(int m_NO, String m_ID, String m_Title, String m_Comment, Date m_Date, String m_Status,
			String m_Category, String m_Count, int m_Brand_NO, int m_Mno, Magazine_File mFile) {
		super();
		this.m_NO = m_NO;
		this.m_ID = m_ID;
	...
	public Magazine_File getmFile() {
		return mFile;
	}

	public void setmFile(Magazine_File mFile) {
		this.mFile = mFile;
	}
	...
	public String toString() {
		return "Magazine [m_NO=" + m_NO + ", m_ID=" + m_ID + ", m_Title=" + m_Title + ", m_Comment=" + m_Comment
				...
				+ m_Count + ", m_Brand_NO=" + m_Brand_NO + ", m_Mno=" + m_Mno + ", mFile=" + mFile + "]";
	}
