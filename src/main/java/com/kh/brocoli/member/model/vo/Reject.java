...
public class Reject {
	...
	private Member rejectMember;  //멤버 정보 가져오기 admin
	...
	public Reject(int re_No, String re_Pname, String re_Price, String re_Reason, String re_Comment, Date re_Date,
			Date re_Enddate, String re_Status, int re_MN_OR_NO, int re_Mno, Member rejectMember) {
		super();
		this.re_No = re_No;
		...
		this.re_Mno = re_Mno;
		this.rejectMember = rejectMember;
	}
	...
	public Member getRejectMember() {
		return rejectMember;
	}

	public void setRejectMember(Member rejectMember) {
		this.rejectMember = rejectMember;
	}
	...
	public String toString() {
		return "Reject [re_No=" + re_No + ", re_Pname=" + re_Pname + ", re_Price=" + re_Price + ", re_Reason="
				...
				+ ", re_Status=" + re_Status + ", re_MN_OR_NO=" + re_MN_OR_NO + ", re_Mno=" + re_Mno + ", rejectMember="
				+ rejectMember + "]";
	}
